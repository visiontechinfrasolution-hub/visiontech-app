...
# =====================================================================
# 🟩 TAB 1: BOQ REPORT (ALL ORIGINAL LOGIC + CLEAN BLANKS)
# =====================================================================
with tab1:
        ...
        if has_filter:
            try:
                ...
                if response.data:
                    ...
                    # --- CLEANING: REPLACE NULLS WITH BLANKS ---
...
# =====================================================================
# 🟦 TAB 2: PO REPORT (LEFT TABLE + CLEAN BLANKS)
# =====================================================================
with tab2:
    ...
    if not st.session_state.get('po_unlocked', False):
        pwd = st.text_input("Enter Password:", type="password", key="p_pwd_v5")
        if st.button("Unlock 🔓", key="p_u_v5"):
        ...
        if sub_po:
            ...
            if res.data:
                ...
                st.table(summary_df) # Left aligned by default

# =====================================================================
# 🏗️ OTHER TABS (SITE & INDUS - CLEANED)
# =====================================================================
with tab3:
    ...
    if st.session_state.get('site_unlocked', False):
        ...
        pwd_s = st.text_input("Enter Password:", type="password", key="s_pwd_v5")
        if st.button("Unlock Site 🔓", key="s_u_v5"):
...
with tab4:
    ...
    with st.form("ind_form_v5"):
        ...
        with i3: in_cl = st.text_input("🗺️ Cluster", key="ind_cl_v5")
