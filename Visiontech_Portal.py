...
# =====================================================================
        ...
        try:
            ...
            st.error("Terminal mein ye run karein: pip install pymupdf")
            st.stop()
        ...
        v_file = st.file_uploader("📂 Upload Fresh PDF", type=['pdf'], key="v_up_unique_vision_99")

        if v_file:
            # 1. Vintage Logic Function
            ...
            try:
                ...
                with st.spinner("⏳ Processing Vintage Effect..."):
                    for page in doc:
