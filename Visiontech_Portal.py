...
# =====================================================================
# 🟩 TAB 1: BOQ REPORT (ONLY CHANGE: MERGE DUPLICATES & SUM QTY)
# =====================================================================
with tab1:
    ...
    if submit_search:
        ...
        if response.data:
            ...
            # Convert Qty to numbers
            for col in qty_cols:
                if col in df.columns:
                    df[col] = pd.to_numeric(df[col], errors='coerce').fillna(0)
            
            # Group by Item Code and sum Quantities, keep first for other columns
            ...
            # Column sequencing and cleaning
...
# =====================================================================
# Baaki Tabs (PO, Site, Indus) mein koi change nahi hai, wahi purana code rahega
# =====================================================================
